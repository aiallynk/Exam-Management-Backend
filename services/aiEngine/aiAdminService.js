...
const OPERATION_META = Object.freeze({
  ...
  [AI_OPERATIONS.QUESTION_IMPORT_ASSISTANCE]: { label: 'Question import assistance', group: 'evaluation' },
  ...
  [AI_OPERATIONS.QUESTION_IMAGE_GENERATION]: { label: 'Question image generation', group: 'evaluation' },
