...
export const AUDIT_ACTIONS = {
  ...
  WIZKIDS_BATCH_CREATED: 'WIZKIDS_BATCH_CREATED',
  WIZKIDS_BATCH_UPDATED: 'WIZKIDS_BATCH_UPDATED',
  WIZKIDS_BATCH_STATUS_CHANGED: 'WIZKIDS_BATCH_STATUS_CHANGED',
  WIZKIDS_BATCH_MEMBER_ADDED: 'WIZKIDS_BATCH_MEMBER_ADDED',
  WIZKIDS_BATCH_MEMBER_REMOVED: 'WIZKIDS_BATCH_MEMBER_REMOVED',
  WIZKIDS_QUESTION_BANK_ITEM_CREATED: 'WIZKIDS_QUESTION_BANK_ITEM_CREATED',
  WIZKIDS_QUESTION_MATERIALIZED: 'WIZKIDS_QUESTION_MATERIALIZED',
  WIZKIDS_PRACTICE_ANSWER_CHECKED: 'WIZKIDS_PRACTICE_ANSWER_CHECKED',
  WIZKIDS_SPEED_STARTED: 'WIZKIDS_SPEED_STARTED',
  WIZKIDS_SPEED_ANSWER_RECORDED: 'WIZKIDS_SPEED_ANSWER_RECORDED',
  WIZKIDS_FLASH_ROUNDS_CREATED: 'WIZKIDS_FLASH_ROUNDS_CREATED',
  WIZKIDS_FLASH_STARTED: 'WIZKIDS_FLASH_STARTED',
  WIZKIDS_FLASH_ANSWER_RECORDED: 'WIZKIDS_FLASH_ANSWER_RECORDED',
  WIZKIDS_FLASH_ROUND_ADVANCED: 'WIZKIDS_FLASH_ROUND_ADVANCED',
  WIZKIDS_TEMPLATE_SEEDED: 'WIZKIDS_TEMPLATE_SEEDED',
  WIZKIDS_TEMPLATE_CREATED: 'WIZKIDS_TEMPLATE_CREATED',
  WIZKIDS_GENERATED_QUESTION_MATERIALIZED: 'WIZKIDS_GENERATED_QUESTION_MATERIALIZED',
  WIZKIDS_ATTEMPT_COMPLETED: 'WIZKIDS_ATTEMPT_COMPLETED',
